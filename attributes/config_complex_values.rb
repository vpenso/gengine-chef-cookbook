# configuration of Grid Engine complex values
default[:gengine][:complex_values] = Hash.new
# defaults for the Grid Engine complex values
default[:gengine][:defaults][:complex_values] = <<-EOF
arch                a          RESTRING    ==    YES         NO         NONE     0
calendar            c          RESTRING    ==    YES         NO         NONE     0
cpu                 cpu        DOUBLE      >=    YES         NO         0        0
display_win_gui     dwg        BOOL        ==    YES         NO         0        0
h_core              h_core     MEMORY      <=    YES         NO         0        0
h_cpu               ct         TIME        <=    YES         NO         0:0:0    0
h_data              h_data     MEMORY      <=    YES         NO         0        0
h_fsize             h_fsize    MEMORY      <=    YES         NO         0        0
h_rss               mem        MEMORY      <=    YES         NO         0        0
h_rt                rt         TIME        <=    YES         NO         0:0:0    0
h_stack             h_stack    MEMORY      <=    YES         NO         0        0
h_vmem              vmem       MEMORY      <=    YES         NO         0        0
